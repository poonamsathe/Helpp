...
import com.blakky.help123.FeedFragment.RowItem;
...
public class HousingFrag extends Fragment{
	...
	class FeedAync extends AsyncTask<String, Void, List<RowItem>>{
		...
		protected List<RowItem> doInBackground(String... params) {
			...
			JSONArray json = null;
			try {
				json = userFunction.getHousingDetails();
				Log.i("tag", json+"");
				if(json!=null){
					...
					for(int i=0;i<json.length();i++)
					{
						...
						String name=json1.getString("house_des");
						String desc=json1.getString("house_detail");
						String address= json1.getString("house_add");
						String contact_no = json1.getString("house_ph");
	...
	public class CustomListViewAdapter extends ArrayAdapter<RowItem> {
		...
		int[] array_img = {R.drawable.house1,R.drawable.house2,R.drawable.house3,R.drawable.house4
				,R.drawable.house5,R.drawable.house6,R.drawable.house7};
