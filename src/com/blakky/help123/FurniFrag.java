...
public class FurniFrag extends Fragment{
	...
	class FeedAync extends AsyncTask<String, Void, List<RowItem>>{
		...
		protected List<RowItem> doInBackground(String... params) {
			...
			JSONArray json = null;
			try {
				json = userFunction.getFurniDetails();
				Log.i("tag", json+"");
				if(json!=null){
					...
					for(int i=0;i<json.length();i++)
					{
						...
						String name=json1.getString("furni_des");
						String desc=json1.getString("furni_detail");
						String address= json1.getString("furni_add");
						String contact_no = json1.getString("furni_ph");
	...
	public class CustomListViewAdapter extends ArrayAdapter<RowItem> {
		...
		int[] array_img = {R.drawable.furni1,R.drawable.furni2,R.drawable.furni3,R.drawable.furni4};
