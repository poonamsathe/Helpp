...
public class PostHouseFragment extends Fragment implements OnItemSelectedListener, OnClickListener{
	...
	private class SendData extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			try {
				...
				String fullURL = "http://omega.uta.edu/~sas4798/housing_post.php?" + toPostPHP;
